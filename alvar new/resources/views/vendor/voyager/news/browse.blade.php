                                    ...
                                    @foreach ($dataTypeContent as $data)
                                        <tr>
                                            ...
                                            <td class="no-sort no-click bread-actions">
                                                ...
                                                <a href="{{ route('news.replicate',[$data->{$data->getKeyName()}]) }}" title="Copy" style="margin-right: 5px"
                                                    class="btn btn-sm btn-success pull-right copy" data-id="{{ $data->{$data->getKeyName()} }}"
                                                    id="delete-1">
                                                    <i class="voyager-documentation"></i> <span
                                                        class="hidden-xs hidden-sm">Copy</span>
                                                </a>

                                                <a href="{{ route('news.replicate',[$data->{$data->getKeyName()},true]) }}" title="Copy And Edit" style="margin-right: 5px"
